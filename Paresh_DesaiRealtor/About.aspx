...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <%--<link href="css/style.css" rel="stylesheet" />--%>
  <div class="wrapper_new botm_mrgn">
        <div class="property-search-container">
            <div class="dt-sc-tabs-container" style="width: 100%;">
                <ul class="dt-sc-tabs-frame">
                    <li><a class="current" href="#">About me</a></li>
                </ul>
                <div style="display: block; padding: 0px;" class="dt-sc-tabs-frame-content back_bggg">
                    <div class="">
                ...
                <div class="">
                    ...
                    <div class="col-md-12 col-sm-12">
                      <div class="about_sct_bg">
                        <%-- <h2>Harvinder Sohi</h2>
                          <span>Real Estate Specialists</span>--%>
                          <p>Harvinder Sohi is the most reputed name in the Real estate industry, committed to make your property buying experience an easier one. 
                     ...
                     <div class="front_socio">
                          <a href="https://www.facebook.com/harvinder.sohi.5030" target="_blank">
                              <img src="images/socio_1.png" /></a>
                           <a href="https://twitter.com/SohiHarv" target="_blank">
                              <img src="images/socio_2.png" /></a>
                           <a href="https://plus.google.com/100392434681162727078" target="_blank">
