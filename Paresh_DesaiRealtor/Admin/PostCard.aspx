                ...
                <div class="form-horizontal row-fluid">
                    ...
                    <div class="newsltr_bg" id="frontside_page">
                        <div style="float: left; width: 97%; background-color: #8a5201; padding: 12px;">
                            <div style="float: left; width: 97%; background-image: url(/PostCardImages/border.png); background-size: cover; background-color: #8a5201;">
                                ...
                                <div id="property_photoproperty_photo_div" data-id="openhouse" style="float: left; width: 100%; text-align: center; margin: 6px 0;">
                        ...
                        <div style="float: left; width: 97%; background-color: #8a5201; padding: 12px;">
                            ...
                            <div style="float: left; width: 60%; text-align: center; margin: 8px 0;">
                                <div style="float: left; width: 100%; text-align: center;">
                                    ...
                                    <h2 style="float: left; width: 100%; color: #1c1c1c; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;">Harvinder Sohi</h2>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Call: 416-618-1251</p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Email: harv@sohirealtor.com </p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Website: www.sohirealtor.com</p>
                            ...
                            <div style="float: left; width: 97%; margin: 8px 0; background-color: #1c1b1d; padding: 6px;">
                                ...
                                <div style="float: left; width: 65%;">
                                    <div style="float: left; background-color: #e8eaec; border-radius: 12px; padding: 6px;">
                                        ...
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Email: harv@sohirealtor.com </p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Website: www.sohirealtor.com</p>
                                        <div style="float: left; width: 97%; padding: 8px; margin: 6px 0; background:#272727;">
                    ...
                    <div class="newsltr_bg" id="feature_Back" style="display: none">
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px;">
                                ...
                                <div style="float: left; width: 100%; margin: 12px 0;">
                                    <div style="float: left; width: 100%; text-align: center;">
                                        ...
                                        <div id="featured_thirld_imge" data-id="featured_thirld" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_thirld_img" src="../PostCardImages/featrd_img2.jpg" alt="" title="" style="width: 100%; border: 2px solid white; height:250px;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div id="featured_fourth_imge" data-id="featured_fourth" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_fourth_img" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white; height:250px;" />
                                        </div>
                                        <div id="featured_fifth_imge" data-id="featured_fifth" style="float: left; width: 48%; padding: 6px;">
                                            <img id="featured_fifth_img" src="../PostCardImages/featrd_img2.jpg" alt="" title="" style="width: 100%; border: 2px solid white; height:250px;" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center; background-color: #101010; padding: 12px 0;">
                                <h2 style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 4px 0; font-weight: bold;">Harvinder Sohi(Sales Representative)</h2>
                    ...
                    <div class="newsltr_bg" id="2nd_featured_back" style="display: none">
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px;">
                                ...
                                <div style="float: left; width: 100%; margin: 12px 0;">
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_2ndimg" data-id="2nd_ftr_2ndimg">
                                            <img id="ftr_2nd_2ndimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white; width:100%; height:250px;" />
                                        </div>
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_3rdimg" data-id="2nd_ftr_3rdimg">
                                            <img id="ftr_2nd_3rdimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white; width:100%; height:250px;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_4thimg" data-id="2nd_ftr_4thimg">
                                            <img id="ftr_2nd_4thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white; width:100%; height:250px;" />
                                        </div>
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_5thimg" data-id="2nd_ftr_5thimg">
                                            <img id="ftr_2nd_5thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white; width:100%; height:250px;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; text-align: center;">
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_6thimg" data-id="2nd_ftr_6thimg">
                                            <img id="ftr_2nd_6thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;width:100%; height:250px;" />
                                        </div>
                                        <div style="float: left; width: 48%; padding: 6px;" id="2nd_ftr_7thimg" data-id="2nd_ftr_7thimg">
                                            <img id="ftr_2nd_7thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white;width:100%; height:250px;" />
                                        </div>
                                    </div>
                                    <div style="float: left; width: 100%; margin: 8px 0; text-align: center;">
                                        <img src="../PostCardImages/featurd_border2.png" alt="" title="" style="margin: 8px 0; width: 55%;" />
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center; background-color: #101010; padding: 12px 0;">
                                <h2 style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 4px 0; font-weight: bold;">Harvinder Sohi</h2>
                                <p style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 2px 0;">Homelife / Miracle Realty Ltd,. Brokerage</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div style="float: left; width: 100%; margin: 4px 0;">
                                    <div style="float: left; width: 100%; padding: 8px;">
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_2ndimge" data-id="jsthold_2ndimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white; width:100%; height:200px;" />
                                        ...
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_3rdimge" data-id="jsthold_3rdimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white; width:100%; height:200px;" />
                                    ...
                                    <div style="float: left; width: 100%; padding: 8px;">
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_4thimge" data-id="jsthold_4thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white; width:100%; height:200px;" />
                                        ...
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_5thimge" data-id="jsthold_5thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white; width:100%; height:200px;" />
                                    ...
                                    <div style="float: left; width: 100%; padding: 8px;">
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_6thimge" data-id="jsthold_6thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white; width:100%; height:200px;" />
                                        ...
                                        <div style="float: left; width: 48%; padding: 6px; background-color: #bc8b3d;">
                                            ...
                                            <img id="jsthold_7thimge" data-id="jsthold_7thimge" src="../PostCardImages/featrd_img1.jpg" alt="" title="" style="width: 100%; border: 2px solid white; width:100%; height:200px;" />
