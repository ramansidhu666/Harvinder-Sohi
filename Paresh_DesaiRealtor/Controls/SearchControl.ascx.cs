    ...
    public partial class SearchControl : System.Web.UI.UserControl
    {
        ...
        void SearchResidentialProperties()
        {
            try
            {
                    ...
                    DataRow[] dr = dt.Select("actualAmount > 100000", "actualAmount ASC");
                    ...
                    //dv.Sort = "actualAmount asc";
                    //DataTable sortedDT = dv.ToTable();
                    count.Text = ("Total Record Found") + " " + dt1.Rows.Count;

                    PagedDataSource pagedData = new PagedDataSource();
                        pagedData.DataSource = dt1.DefaultView;
        ...
        void SearchResidentialPropertiesSearch()
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    PagedDataSource pagedData = new PagedDataSource();
                    pagedData.DataSource = sortedDT.DefaultView;
                    pagedData.AllowPaging = true;
                    pagedData.PageSize = 8;
                    pagedData.CurrentPageIndex = CurrentPage;
                    ViewState["totpage"] = pagedData.PageCount;
